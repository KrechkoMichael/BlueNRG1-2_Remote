...
/* Number of links needed for the  demo: 4 */
#define NUM_LINKS	(4)
...
/* Number of GATT services needed for the  demo */
...
#define ATT_VALUE_ARRAY_SIZE	162//(143 + OTA_ATT_VALUE_ARRAY_SIZE) //TODO auto generated value is not enough, check it
